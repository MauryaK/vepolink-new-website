  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        boxShadow:
          "0 24px 60px -30px rgba(10,18,32,0.18), 0 2px 6px -2px rgba(10,18,32,0.04)",
      }}
    >
      {/* chrome bar */}
      <div
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          >
            vepolink<span style={{ opacity: 0.4 }}>.io</span> / stations /
            chembarambakkam-stp / live
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <span
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13.5, fontWeight: 500, marginTop: 2 }}>
              Turbidity trending toward upper bound — 3.8 NTU at Station
              5572-TN-08
            </div>
          </div>
        </div>
