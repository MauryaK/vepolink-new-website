              ...
              {thumb.map((t, index) => (
                <Reveal key={t.id} delay={120 * index}>
                  <button
                    ...
                    className={`w-[56px] h-[56px] md:w-[60px] md:h-[60px] shrink-0 border rounded p-1 transition ${
  ...
  const techData = [
    {
      i: "drop",
      t: "Direct Absorbance",
      d: "Direct absorbance measurement for <b>UVA, COD, BOD, TOC, NO3, Colour PO4 and Cr VI brings fast and stable</b> measurements with a simple hydraulic circuit. The analyzers are factory calibrated and local multi-point calibration allows to get readings of COD, BOD and TOC under the UV alternative method for compatible applications. UV spectroscopy brings faster results than conventional methods like COD, BOD, TOC with much less maintenance once the correlation is determined.",
    },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5 mt-10 md:mt-12 max-w-[1170px] ml-auto mr-auto">
          <div className="flex flex-row gap-2 px-3">
            ...
            <div>
              ...
              <p className="text-sm text-(--muted)">
                Build for continuous operation
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row gap-2 px-3 lg:border-l lg:border-(--line)">
            ...
            <div>
              ...
              <p className="text-sm text-(--muted)">
                Plug-and-paly design for quick setup
              </p>
            </div>
          </div>
        </div>
  ...
  <section className="md:py-[120px] md:px-[48px] py-[100px] px-[16px]">
    <div className="max-w-[1320px] m-auto bg-(--ink) text-(--paper-2) rounded-[8px] md:py-[72px] md:px-[64px] p-8 relative overflow-hidden">
      ...
      <div className="relative grid md:grid-cols-2 grid-cols-1 md:gap-[64px] gap-[35px]  align-start">
        ...
        <div className="col-span-1">
          <form className="prod-form flex flex-wrap p-2">
