    ...
    <section style={{ padding: "32px 48px 0", position: "relative" }}>
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        >
          {headline === "instrument" && (
            <>
              Instrument-grade water intelligence,
              <br />
        ...
        >
          ...
          >
            Vepolink turns IoT-enabled analyzers — pH, turbidity, dissolved
            oxygen, temperature, conductivity — into a single, compliance-ready
            picture of every effluent, intake and treatment line you operate.
          </p>
          <div
            style={{
              display: "flex",
  ...
  <section style={{ padding: "120px 48px 40px" }}>
    <div style={{ maxWidth: 1320, margin: "0 auto" }}>
      ...
      >
        ...
        >
          A real-time data acquisition, monitoring and analytics platform built
          for environmental compliance — designed to meet the operational
          reality of a plant supervisor, not the imagination of a software
          vendor.
        </p>
      </div>
...
const CapCard = ({ icon, eyebrow, title, body, metric, span, visual }) => (
  ...
  >
    ...
    >
      <span
        className="mono"
        style={{ fontSize: 11.5, letterSpacing: "0.06em", color: "var(--ink)" }}
      >
        {metric}
      </span>
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: 99,
                    background:
                      i === 2 ? "var(--signal-warn)" : "var(--signal-ok)",
                  }}
                />
                <span
                  className="mono"
        ...
        {[
          {
            c: "var(--signal-alert)",
            t: "14:32",
            l: "Turbidity ↑ 4.8 NTU — Outfall A",
          },
          {
            c: "var(--signal-warn)",
            t: "14:18",
            l: "pH approaching 8.4 — Intake 02",
          },
          {
            c: "var(--signal-ok)",
            t: "13:55",
            l: "DO restored — Aerator-3 back online",
          },
        ].map((a, i) => (
          <div
            key={i}
          ...
          >
            <span
              style={{ width: 6, height: 6, borderRadius: 99, background: a.c }}
            />
            <span
              className="mono"
    ...
    return (
      ...
      >
        <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
          {["Modbus", "MQTT", "4-20mA", "OPC-UA", "RS-485", "Ethernet"].map(
            (p) => (
              <span
                key={p}
                className="mono"
  ...
  const steps = [
    {
      ...
      k: "Sensor",
      t: "Field analyser",
      d: "pH, turbidity, DO, ORP, conductivity, temperature, ammonia, BOD/COD probes — yours or ours.",
    },
    {
      n: "02",
      k: "DAS",
      t: "Plug-and-play DAS",
      d: "Multi-protocol, multi-channel data acquisition with onboard buffering. OTA-configurable in the field.",
    },
    {
      n: "03",
      k: "Cloud",
      t: "Vepolink cloud",
      d: "Serverless ingest, station tagging, big-data time-series store, REST & OPC-UA outputs.",
    },
    {
      n: "04",
      k: "View",
      t: "Live dashboard",
      d: "Operators, supervisors, plant heads, regulators — each gets the view they actually need.",
    },
    {
      n: "05",
      k: "Act",
      t: "Alerts & reports",
      d: "Pre-threshold SMS/email, automated forms for SPCB/CPCB filings, third-party API push.",
    },
  ];
  return (
    <section
        ...
        >
          ...
          <div
            style={{
              ...
              height: 1,
              background:
                "linear-gradient(90deg, transparent, var(--ink-3) 12%, var(--ink-3) 88%, transparent)",
            }}
          />
          {steps.map((s, i) => (
            <div
  ...
  <section style={{ padding: "120px 48px" }}>
    ...
    >
      <div>
        ...
        >
          CEMS-style continuity for water. Reporting mapped to your state
          pollution control board templates. Calibration certificates retained
          for the full audit lifecycle, retrievable in two clicks.
        </p>
        <ul
          style={{
            listStyle: "none",
          ...
          {[
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 13.5, color: "var(--mute)", marginTop: 2 }}
                >
                  {v}
                </div>
              </div>
  ...
  >
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      {[
        ...
        <div
          ...
          style={{
            display: "grid",
            gridTemplateColumns: "20px 1.2fr 0.8fr 1.4fr 60px",
            alignItems: "center",
            gap: 10,
            padding: "10px 12px",
            background: "var(--paper-2)",
        ...
        >
          ...
          <span
            className="mono"
            style={{ fontSize: 10.5, color: "var(--mute)", textAlign: "right" }}
          >
            SMS · MAIL
          </span>
        </div>
    ...
    <div
      style={{
        ...
        borderRadius: 4,
        background:
          "linear-gradient(0deg, rgba(122,63,228,0.06), rgba(60,200,223,0.06))",
        border: "1px solid var(--line)",
        display: "flex",
        alignItems: "center",
        justifyContent: "space-between",
      ...
      >
        ...
        <div>
          ...
          >
            ...
            compliance reporting. Hardware shipped from Pune, commissioned by
            our team.
          </p>
    ...
    <div style={{ maxWidth: 1320, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          >
            Real-time data acquisition, monitoring and analytics for
            environmental compliance. Designed for industries that take water
            seriously.
          </p>
          <div
            className="mono"
        ...
        {[
          ...
          [
            "Company",
            ["About", "Careers", "Channel partners", "Press", "Contact"],
          ],
        ].map(([h, items]) => (
          <div key={h}>
            <div
      ...
      >
        ...
        <div style={{ display: "flex", gap: 20 }}>
          {["Privacy", "Terms", "Security", "SLA", "Data residency"].map(
            (l) => (
              <a
                key={l}
                href="#"
